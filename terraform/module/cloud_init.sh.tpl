...
# Pass mysql_databases as a JSON string; single-quote it to protect special chars from shell expansion
EXTRA_VARS="$EXTRA_VARS mysql_databases='${mysql_databases}'"
